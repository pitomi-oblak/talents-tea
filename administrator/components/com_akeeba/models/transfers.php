...
class AkeebaModelTransfers extends F0FModel
{
	...
	public function getFTPSupport()
	{
		...
		$result['firewalled'] = array(
			'ftpcurl'	=> !$result['supported']['ftpcurl'] ? false : Transfer\FtpCurl::isFirewalled(),
			'ftpscurl'	=> !$result['supported']['ftpscurl'] ? false : Transfer\FtpCurl::isFirewalled(array('ssl' => true)),
			'sftpcurl'	=> !$result['supported']['ftpscurl'] ? false : Transfer\SftpCurl::isFirewalled(),
	...
	{
		// Default11 reported memory limit: 8Mb
		$memLimit = 8388608;
