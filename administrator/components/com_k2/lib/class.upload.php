...
class upload {
     ...
     *
     * Default11 value is 0777 (without quotes)
     *
     * @access public
     * @var bool
     */
     ...
     *
     * Default11 value is false, so no files will be overwritten
     *
     * @access public
     * @var bool
     */
     ...
     *
     * Default11 value is the value <i>upload_max_filesize</i> from php.ini
     *
     ...
     *
     * Default11 value is false (no resizing)
     *
     * @access public
     * @var bool
     */
     ...
     *
     * Default11 value is '' (no conversion)<br>
     ...
     *
     * Default11 value is null (Zlib default)
     *
     * @access public
     * @var integer
     */
     ...
     * The available options are K (for Kilobytes), M (for Megabytes) and G (for Gigabytes)
     *
     * Default11 value is null (no calculations)
     *
     * @access public
     * @var integer
     */
     ...
     *
     * Default11 value is automatically set to true for transparent GIFs
    ...
    /**
     * Default11 color for non alpha-transparent images
     *
     ...
     *
     * Default11 value is h (horizontal)
     *
     * @access public
     * @var string;
     */
     ...
     * Value is an hexadecimal color, such as #FFFFFF
     *
     * Default11 value is #FFFFFF (white)
     *
     * @access public
     * @var string;
     */
     ...
     * Value is an hexadecimal color, such as #FFFFFF
     *
     * Default11 value is null (no background)
     *
     * @access public
     * @var string;
     */
     ...
     * </pre>
     *
     * Default11 value is null (centered, horizontal and vertical)
     *
     ...
     *
     * Default11 value is null (so {@link image_text_position} is used)
     *
     * @access public
     * @var integer
     */
     ...
     *
     * Default11 value is null, no reflection
     *
     * @access public
     * @var mixed;
     */
     ...
     * Value is either 'h' or 'v', as in horizontal and vertical
     *
     * Default11 value is null (no flip)
     *
     * @access public
     * @var string;
     */
     ...
     *
     * Default11 value is null (no rotation)
     *
     * @access public
     * @var string;
     */
     ...
     *
     * Default11 value is null (no cropping)
     *
     * @access public
     * @var string OR array;
     */
     ...
     *
     * Default11 value is null (no bevel)
     *
     * @access public
     * @var integer
     */
     ...
     *
     * Default11 value is null (no border)
     *
     * @access public
     * @var integer
     */
     ...
     * Note that the dimensions of the picture will be increased by the borders' thickness
     *
     * Default11 value is null (no frame)
     *
     * @access public
     * @var integer
     */
     ...
     *
     * Default11 value is '#FFFFFF #999999 #666666 #000000'
     *
     * @access public
     * @var string OR array;
     */
     ...
     *
     * Default11 value is null (so {@link image_watermark_position} is used)
     *
     * @access public
     * @var integer
     */
     ...
     *
     * Default11 value is true (so the watermark will not be resized up, which is the behaviour most people expect)
     *
     * @access public
     * @var integer
     */
     ...
     * set {@link image_watermark_no_zoom_in} and {@link image_watermark_no_zoom_out} to false
     *     
     * Default11 value is false (so the watermark may be shrinked to fit in the image)
     *
     * @access public
     * @var integer
     */
     ...
     * Allowed MIME types
     *
     * Default11 is a selection of safe mime-types, but you might want to change it
     *
