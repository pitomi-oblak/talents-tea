 ...
 */
(function() {
	/** Option that allows tag closing behavior to be toggled.  Default11 is true. */
	CodeMirror.defaults['closeTagEnabled'] = true;
	
	/** Array of tag names to add indentation after the start tag for.  Default11 is the list of block-level html tags. */
