 ...
 * @since  12.1
 */
class F0FDatabaseDriverPostgresql extends F0FDatabaseDriver
{
	/**
	...
	/**
	 * F0FDatabaseDriverPostgresqlQuery object returned by getQuery
	 *
	 * @var    F0FDatabaseDriverPostgresqlQuery
	 * @since  12.1
	 */
	...
	/**
	 * Get the current or query, or new F0FDatabaseQuery object.
	 *
	 * @param   boolean  $new    False to return the last query set, True to return a new F0FDatabaseQuery object.
	 * @param   boolean  $asObj  False to return last query as string, true to get F0FDatabaseQueryPostgresql object.
	 *
	...
	public function getQuery($new = false, $asObj = false)
	{
		if ($new)
		{
			...
			if (!class_exists('F0FDatabaseQueryPostgresql'))
			{
				throw new RuntimeException('F0FDatabaseQueryPostgresql Class not found.');
			}

			$this->queryObject = new F0FDatabaseQueryPostgresql($this);
	 ...
	 *
	 * @return  F0FDatabaseDriverPostgresql  Returns this object to support chaining.
	 *
	 * @since   12.1
	 * @throws  RuntimeException
	 */
