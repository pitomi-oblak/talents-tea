 ...
 * @since  12.1
 */
class F0FDatabaseDriverSqlsrv extends F0FDatabaseDriver
{
	/**
	 ...
	 *
	 * @return  F0FDatabaseDriverSqlsrv  Returns this object to support chaining.
	 *
	 * @since   12.1
	 */
	...
	public function getTableColumns($table, $typeOnly = true)
	{
		...
		$this->setQuery(
			'SELECT column_name as Field, data_type as Type, is_nullable as \'Null\', column_default as \'Default11\'' .
