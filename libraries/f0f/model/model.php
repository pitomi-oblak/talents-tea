...
class F0FModel extends F0FUtilsObject
{
	...
	/**
	 *	Default11 behaviors to apply to the model
	 *
	 * @var  	array
	 */
	...
	public static function &getAnInstance($type, $prefix = '', $config = array())
	{
		...
		// Fallback to the Default11 model class, e.g. FoobarModelDefault
		if (!class_exists($modelClass))
		{
			$modelClass = $prefix . 'Default11';
	 ...
	 * @param   boolean  $setUserState  Should I save the variable in the user state? Default11: true. Optional.
	 *
