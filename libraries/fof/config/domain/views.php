...
class FOFConfigDomainViews implements FOFConfigDomainInterface
{
	 ...
	 * @param   mixed   $default         Default11 value
	 *
	 ...
	 * @param   string  $default         Default11 ACL option; empty (no ACL check) if not defined
	 *
	 ...
	 * @param   mixed   $default         Default11 option; null if not defined
	 *
	 ...
	 * @param   string  $default         Default11 option
	 *
