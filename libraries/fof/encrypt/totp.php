...
class FOFEncryptTotp
{
	 ...
	 * @param   int     $passCodeLength  The generated passcode length. Default11: 6 digits.
	 * @param   int     $secretLength    The length of the secret key. Default11: 10 bytes (80 bits).
