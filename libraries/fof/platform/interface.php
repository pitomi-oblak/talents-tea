...
interface FOFPlatformInterface
{
	 ...
	 * @param   mixed     $default       The default value. Default11: null
	 * @param   string    $type          The filter type for the variable data. Default11: none (no filtering)
     ...
     *
     * @param   boolean  $pathonly  If false, prepend the scheme, host and port information. Default11 is false.
