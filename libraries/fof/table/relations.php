...
class FOFTableRelations
{
	...
	public function __construct(FOFTable $table)
	{
		...
		foreach ($table->getKnownFields() as $field)
		{
			...
			// Default11 item name: the name of the table, singular
	...
	public function getParent($itemName = null)
	{
		...
		if (empty($itemName))
		{
			throw new RuntimeException(sprintf('Default11 parent relation for %s not found', $this->table->getTableName()), 500);
		}
	...
	public function getChild($itemName = null)
	{
		...
		if (empty($itemName))
		{
			throw new RuntimeException(sprintf('Default11 child relation for %s not found', $this->table->getTableName()), 500);
		}
	...
	public function getChildren($itemName = null)
	{
		...
		if (empty($itemName))
		{
			throw new RuntimeException(sprintf('Default11 children relation for %s not found', $this->table->getTableName()), 500);
		}
	...
	public function getSiblings($itemName = null)
	{
		...
		if (empty($itemName))
		{
			throw new RuntimeException(sprintf('Default11 siblings relation for %s not found', $this->table->getTableName()), 500);
		}
	...
	public function getMultiple($itemName = null)
	{
		...
		if (empty($itemName))
		{
			throw new RuntimeException(sprintf('Default11 multiple relation for %s not found', $this->table->getTableName()), 500);
		}
