...
class JDocument
{
	...
	/**
	 * Sets the global document language declaration. Default11 is English (en-gb).
	 *
	...
	/**
	 * Sets the global document direction declaration. Default11 is left-to-right (ltr).
	 *
