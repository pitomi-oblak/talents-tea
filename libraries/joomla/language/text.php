...
class JText
{
	 ...
	 * will generate an alert message containing 'Default11'
	 * <?php echo JText::_("JDEFAULT");?> it will generate a 'Default11' string
	 *
	...
	public static function plural($string, $n)
	{
		...
		elseif ($count > 0)
		{
			// Default11 to the normal sprintf handling.
