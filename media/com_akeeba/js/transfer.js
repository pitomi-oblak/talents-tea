...
(function($){
    ...
    akeeba.Transfer.onTransferMethodChange = function(e)
    {
        ...
        $('#akeeba-transfer-ftp-passive-fix-container').hide();
		...
		{
			$('#akeeba-transfer-ftp-passive-fix-container').show();
		}
    ...
    akeeba.Transfer.FtpBrowser.initialise = function()
    {
        ...
        akeeba.Transfer.FtpBrowser.params.passive_fix = $('#akeeba-transfer-ftp-passive_fix1').is(':checked') ? 1 : 0;
    ...
    akeeba.Transfer.FtpBrowser.open = function () {
        ...
        var data = {
            ...
            'passive_fix':  (akeeba.Transfer.FtpBrowser.params.passive_fix ? 1 : 0),
    ...
    akeeba.Transfer.applyConnection = function()
    {
        ...
        var data = {
            ...
            passive_fix:    $('#akeeba-transfer-ftp-passive_fix1').is(':checked') ? 1 : 0,
