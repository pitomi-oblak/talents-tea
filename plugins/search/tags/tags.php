...
class PlgSearchTags extends JPlugin
{
	 ...
	 * @param   string  $phrase    Matching option (possible values: exact|any|all).  Default11 is "any".
	 * @param   string  $ordering  Ordering option (possible values: newest|oldest|popular|alpha|category).  Default11 is "newest".
