...
<div id="btk2Container" class=" <?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
<div class="btcontent-area" id="btprimary">
<div  class="btsite-content" id="btcontent">
	...
	<!-- Item list -->
	<div class="blog-section col<?php echo $this->params->get('num_leading_columns');?> triggerAnimation animated" data-animate="fadeInUp">

		<?php if(isset($this->leading) && count($this->leading)): ?>
		<!-- Leading items -->
		<?php  if  ($this->params->get('num_leading_columns') == 2) echo '<div class="row">';?>
			...
			if( (($key+1)%($this->params->get('num_leading_columns'))==0) || count($this->leading)<$this->params->get('num_leading_columns') )
				...
				$lastContainer='';
			?>
            <div <?php if ($this->params->get('num_leading_columns') == 2) echo 'class="col-md-6"'; ?>>
			<div class="blog-post">
			<?php
        ...
        <?php if  ($this->params->get('num_leading_columns') == 2) echo '</div>'?>
		<?php endif; ?>
