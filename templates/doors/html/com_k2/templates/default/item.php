...
<div class="blog-single <?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
<div class="single-post triggerAnimation animated" data-animate="flipInY">
    ...
    <div class="entry-header">
		<p class="date" style="display: none;"><span>
		...
		<div class="entry-meta">
    		...
    		<?php endif; ?>
			<span><?php if($this->item->params->get('itemCategory')): ?>
            <i class="fa fa-tag"></i>
    		<!-- Item category -->
...
<div class="social-share">
	...
	<div class="single-post-content">
		...
		<ul class="post-tags">
            ...
            <li>
            	...
            	<?php if($this->item->params->get('itemHits')): ?><i class="fa fa-heart"></i>
			<!-- Item Hits -->
			<span class="btitemHits">
  ...
  <div class="media author-details">
     <h2 class="itemAuthorName">
  	...
  	<a class="pull-left"  rel="author" href="<?php echo $this->item->author->link; ?>">
      <img class="media-object" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
  	</a>
      <?php endif; ?>
	  ...
	  <ul class="media-list">
	    ...
	    <li class="media">
            <div class="post-comment">
				...
				<img class="media-object" src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" />
				<?php endif; ?>
