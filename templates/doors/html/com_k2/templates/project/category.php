...
<div data-animate="fadeInRightBig" class="portfolio triggerAnimation animated <?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div >
		...
		<!-- Leading items -->
		<div class="portfolio-box col<?php echo $this->params->get('num_leading_columns');?>">
			...
			<div class="project-post <?php echo $lastContainer; ?>">
				<?php
