    ...
    <div class="sigProGalleriaWhitePlaceholder">
        <div class="grid-gallery row">
            ...
            foreach ($gallery as $count => $photo) { ?>
                <div class="grid-photo col-xs-6 col-sm-6 col-md-3">
                    <a href="<?php echo $gallery[$i]->sourceImageFilePath; ?>"
                       ...
                       target="_blank"
                       style="display: block; background-position: center; background-size: cover; background-image: url(<?php echo $gallery[$i]->sourceImageFilePath; ?>)">
