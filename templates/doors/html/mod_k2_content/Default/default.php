...
<div id="blog" class="padding-top padding-bottom">
<div class="container">
    <div class="row text-center section-title">
		<div class="col-sm-6 col-sm-offset-3">
			<h3 class="wow fadeInDown" data-wow-duration="700ms" data-wow-delay="300ms"><?php echo $module->title;?></h3>
		...
		<div class="single-blog wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">
			<div class="blog-image">
				...
				<div class="post-date">
                  ...
                  <?php //echo JText::_('K2_WRITTEN_ON') ; ?> <?php echo JHTML::_('date', $item->created, 'd'); ?>
                  <?php endif; ?>
                    <?php if($params->get('itemDateCreated')): ?>
			...
			<div class="entry-content">				<a class="moduleItemTitle" href="<?php echo $item->link; ?>">
				<h2><?php if($params->get('itemTitle')): ?>
          <?php echo $item->title; ?>
          <?php endif; ?></h2></a>
